...
class LevelTwoDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_two.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelTwo') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelTwo') ?
                        [
