...
class LevelFiveDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_five.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelFive') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelFive') ?
                        [
