...
class LevelFourDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_four.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelFour') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelFour') ?
                        [
