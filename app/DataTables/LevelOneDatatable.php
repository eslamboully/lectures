...
class LevelOneDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_one.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelOne') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelOne') ?
                        [
