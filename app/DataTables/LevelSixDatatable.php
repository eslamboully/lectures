...
class LevelSixDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_six.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelSix') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelSix') ?
                        [
