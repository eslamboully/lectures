...
class LevelNineDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_nine.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelNine') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelNine') ?
                        [
