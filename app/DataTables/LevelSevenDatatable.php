...
class LevelSevenDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_seven.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelSeven') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelSeven') ?
                        [
