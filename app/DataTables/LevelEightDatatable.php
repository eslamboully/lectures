...
class LevelEightDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('control', 'levels::level_eight.datatables.control')
	...
	public function html() {
		return $this->builder()
			...
			->parameters([
                ...
                'buttons' => [
                    $permission = auth()->guard('admin')->user()->can('add_levelEight') ?
                        [
                    ...
                    $permission = auth()->guard('admin')->user()->can('delete_levelEight') ?
                        [
