...
@section('content')
    ...
    <section class="content-header">
        <h1 style="font-family: 'Cairo', sans-serif;">
            @lang('admin::admin.level_three')
            <small>@lang('admin::admin.control_panel')</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i> @lang('admin::admin.home')</a></li>
            <li><a href="{{ route('level_threes.index') }}"><i class="fa fa-user"></i> @lang('levels::level.level_three')</a></li>
	...
	<div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              {!! Form::open(['route' => ['level_threes.update' , $row->id]  , 'method' => 'PUT']) !!}
