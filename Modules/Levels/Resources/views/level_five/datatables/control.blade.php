...
<a class="btn btn-primary" href="{{ route('level_fives.edit' , $id) }}">
...
<a class="btn btn-danger" href="{{ route('level_fives.destroy' , $id) }}" data-toggle="modal" data-target="#del_admin{{ $id }}">
...
<div id="del_admin{{ $id }}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      {!! Form::open(['route'=>['level_fives.destroy',$id],'method'=>'DELETE']) !!}
