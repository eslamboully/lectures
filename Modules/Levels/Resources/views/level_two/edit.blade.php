...
@section('content')
	...
	<div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              {!! Form::open(['route' => ['level_twos.update' , $row->id]  , 'method' => 'PUT']) !!}
