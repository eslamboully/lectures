...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('levels::level.level_nine')</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box-header">
            <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">@lang('levels::level.level_nine')</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            {!! Form::open(['id' => 'form_data' , 'url' => route('delete_level_nine') ]) !!}
